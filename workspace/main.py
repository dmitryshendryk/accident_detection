...
def load_VGG16_model():
  base_model = VGG16(weights=ROOT_DIR + '/model_data/' + 'vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5', include_top=False, input_shape=(224,224,3))
  print ("Model loaded..!")
